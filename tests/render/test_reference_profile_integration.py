...
def test_new_project_api_defaults_to_60fps_reference_profile_and_55_seconds(auth_client):
    ...
    assert body["target_duration"] == 55
...
def test_new_project_form_submits_reference_profile_explicitly():
    ...
    assert 'value="{{ default_target_seconds }}"' in html
    assert "defaultValue" in javascript
    assert "|| 41" not in javascript
