...
def test_sharp_friend_materializes_flexible_script_and_persists_identity(db):
    ...
    assert identity == {
        ...
        "version": "1.1.0",
        "sha256": "678543c42e7894ae10a04fd6ce84105d044c2b4922770b2c7baaed5f36ac3e40",
    }
...
def test_analysis_status_exposes_only_safe_narrative_identity_summary(db):
    ...
    assert status["narrative_profile_version"] == "1.1.0"
...
def test_api_accepts_profile_on_script_request_and_returns_safe_metadata(auth_client):
    ...
    from app.services import pipeline as pipeline_service
    from tests.factories.vision_api import _make_project, _seed_analysis
...
def test_analysis_api_forwards_explicit_narrative_profile_body(
    ...
    from tests.factories.vision_api import _make_project
...
def test_run_analysis_explicitly_carries_sharp_friend_identity_to_provider(
    ...
    from app.services import pipeline as pipeline_service
    from tests.factories.vision_pipeline import (
        _install_provider,
        _ProviderSpy,
    ...
    assert request.narrative_profile_version == "1.1.0"
