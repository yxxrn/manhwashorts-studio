...
REVIEW_BLUR_FIT_FULL_PANEL_ROI_LABEL = "blur_fit_full_panel_v1"
REVIEW_BLUR_FIT_FULL_PANEL_REASON = "review.blur_fit_full_panel"
REVIEW_BLUR_FIT_FOREGROUND_MARGIN_RATIO = 0.035
REVIEW_BLUR_FIT_BACKGROUND_BLUR_RATIO = 0.025
PRODUCTION_REFERENCE_CADENCE_POLICY_VERSION = "production-reference-cadence-v8"
