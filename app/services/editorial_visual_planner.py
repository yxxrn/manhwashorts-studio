    ...
    *,
    ...
    for section in section_names:
        ...
        if allow_standard_cadence_adaptation:
            # Final production still prefers one distinct evidence panel per shot,
            # but preserve extra safe-ROI capacity as an emergency fallback when
            # unique panels cannot satisfy the four-second ceiling.  The
            # allocation helper below returns unique capacity whenever that is
